...
'''
This is the GNU Radio FIREHOSEMODULE module. Place your Python package
...
# import swig generated symbols into the firehoseModule namespace
try:
    # this might fail if the module is python-only
    from .firehoseModule_swig import *
